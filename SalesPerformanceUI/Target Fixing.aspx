<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Target Fixing.aspx.cs" Inherits="SalesPerformanceUI.Target_Fixing" %>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label text-right font-bold" for="DraftNo">BusinessType</label>

                                                            <div class="col-md-5">



                                                                <asp:DropDownList ID="DDBusinessType" CssClass="form-control form-control-sm text-box single-line" runat="server">
                                                                    <asp:ListItem Enabled="true" Text="New Business" Value="New Business"></asp:ListItem>
                                                                    <asp:ListItem Text="Renewal Business" Value="Renewal Business"></asp:ListItem>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label text-right font-bold" for="DraftNo">Product Name</label>
                                                            <div class="col-md-5">

                                                                <asp:DropDownList ID="DropDownList2" CssClass="form-control form-control-sm text-box single-line" runat="server">
                                                                    <asp:ListItem Enabled="true" Text="GL" Value="GL"></asp:ListItem>
                                                                    <asp:ListItem Text="WC" Value="WC"></asp:ListItem>
                                                                    <asp:ListItem Text="Fir" Value="Fir"></asp:ListItem>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label text-right font-bold" for="DraftNo">Policy Number</label>
                                                            <div class="col-md-5">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label text-right font-bold" for="DraftNo">Policy Start Date</label>
                                                            <div class="col-md-5">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label text-right font-bold" for="DraftNo">Policy End Date</label>
                                                            <div class="col-md-5">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label text-right font-bold" for="PolicyNo">Renewal Base</label>
                                                            <div class="col-md-5">
                                                                <asp:TextBox ID="txtRenewalBase" runat="server" CssClass="form-control form-control-sm text-box single-line"></asp:TextBox>
                                                            
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label text-right font-bold" for="Branch">Probable Renewal</label>
                                                            <div class="col-md-5">
                                                                <asp:TextBox ID="txtProbableRenewal" runat="server" CssClass="form-control form-control-sm text-box single-line"></asp:TextBox>
                                                          ...
                                                          <div class="form-group row">
                                                            <label class="col-sm-4 col-form-label text-right font-bold" for="PolicyNo">Status</label>
                                                            <div class="col-md-5">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row">
                                                                 ...
                                                                 <asp:Button ID="BtnSave" runat="server" CssClass="col-2 ,btn btn-primary btn-sm" Text="Save " OnClick="BtnSave_Click" />
                                                                 <asp:Button ID="BtnClose" runat="server" CssClass="col-2 ,btn btn-primary btn-sm" Text="Close " OnClick="BtnClose_Click" />
                                                                <asp:Button ID="BtnUpdate" runat="server" CssClass="col-2 ,btn btn-primary btn-sm" Text="Update " OnClick="BtnUpdate_Click" />
